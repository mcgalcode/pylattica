...
def test_site_class_neighborhood():
    ...
    struct = PeriodicStructure.build_from(lattice, (3, 3), motif)
...
def test_fully_periodic_neighborhoods():
    ...
    full_periodic_struct = PeriodicStructure.build_from(
        full_periodic_lattice, (3, 3), motif
    )
...
def test_partially_periodic_neighborhoods():
    ...
    partial_periodic_struct = PeriodicStructure.build_from(
        partial_periodic_lattice, (3, 3), motif
    )
...
def test_non_periodic_neighborhoods():
    ...
    non_periodic_struct = PeriodicStructure.build_from(
        non_periodic_lattice, (3, 3), motif
    )
